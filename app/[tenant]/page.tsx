...
import { ArrowRight, CalendarDays, ClipboardCheck, HeartHandshake, PawPrint, ShieldCheck } from 'lucide-react'
      ...
      <section className="border-b border-stone-200 bg-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold">{tenant.business_name}</span>
          </div>
      ...
      <section className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1.2fr_0.8fr] lg:py-20">
        <div>
          ...
          <h1 className="max-w-3xl text-4xl font-bold tracking-tight sm:text-5xl">
            Dependable walks, thoughtful updates, and a smoother routine for busy pet owners.
          </h1>
